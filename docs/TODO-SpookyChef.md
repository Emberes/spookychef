...
**Scope:** Recept-chatt i Next.js. Slumpad persona per ny chatt (~20 i poolen). PG‑16. *Recept only* (även för tysta personas). Parodi/inspirerad ton, inga direkta citat/catchphrases. IMDb‑länk i UI.
